...
local_exe   = "dist/Ashish_Kumar_NexusSyncPro_v15.3-BETA.exe"
s3_key      = "beta/Ashish_Kumar_NexusSyncPro_v15.3-BETA.exe"
...
info_path = "dist/v15.3-beta-build-info.txt"
with open(info_path, "w") as f:
    f.write(f"Version: 15.3-BETA\n")
